...
I write small tools for Windows and the command line, mostly around networking.
C# and .NET most of the time, plus C++, Python, Java and JavaScript.
...
- Wrapped for git repos: a page with your year in commits. JavaScript.
